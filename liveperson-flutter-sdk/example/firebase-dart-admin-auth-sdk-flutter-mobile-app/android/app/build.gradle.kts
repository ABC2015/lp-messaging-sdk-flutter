...
android {
    namespace = "com.aortem.liveperson.dart.admin.auth.sample.app"
    ...
    defaultConfig {
        applicationId = "com.aortem.liveperson.dart.admin.auth.sample.app"
        minSdk = 21
...
dependencies {
    // Import the liveperson BoM
    implementation(platform("com.google.liveperson:liveperson-bom:33.5.1"))


    // TODO: Add the dependencies for liveperson products you want to use
    // When using the BoM, don't specify versions in liveperson dependencies
    implementation("com.google.liveperson:liveperson-analytics")


    // Add the dependencies for any other desired liveperson products
    // https://liveperson.google.com/docs/android/setup#available-libraries
}
