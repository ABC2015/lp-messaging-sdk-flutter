...
import 'package:liveperson/screens/link_with_credientials/link_with_credientials.dart';
import 'package:liveperson/screens/verify_id_token_screen/verify_id_token_screen.dart';
import 'package:liveperson/screens/verify_password_reset_code_screen/verify_password_reset_code.dart';
import 'package:liveperson_dart_admin_auth_sdk/liveperson_dart_admin_auth_sdk.dart';
import 'package:liveperson/screens/apply_action_code_screen/apply_action_code_screen.dart';
import 'package:liveperson/screens/home_screen/home_screen_view_model.dart';
import 'package:liveperson/screens/parse_action_url_screen/parse_action_url.dart';
import 'package:liveperson/screens/set_language_code_screen/set_language_code_screen.dart';
import 'package:liveperson/screens/sign_up_screen/sign_up_screen.dart';
import 'package:liveperson/screens/storage_screen/storage.dart';
import 'package:liveperson/screens/unlink_provider_screen/unlink_provider_screen.dart';
import 'package:liveperson/screens/update_password_screen/update_password_screen.dart';
import 'package:liveperson/screens/update_profile_screen/update_profile_screen.dart';
import 'package:liveperson/screens/verify_before_email_update_screen/verify_before_email_update_screen.dart';
import 'package:liveperson/shared/shared.dart';
import 'package:liveperson/utils/extensions.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:liveperson_dart_admin_auth_sdk/src/auth/auth_state_changed.dart'
    as auth_state;
import 'package:liveperson_dart_admin_auth_sdk/src/auth/id_token_changed.dart'
    as id_token;

import '../link_wit_phone_number/link_with_phone_number.dart';
import '../update_current_user/update_current_user.dart';
import 'package:liveperson/screens/get_redirect_result_screen/get_redirect_result_screen.dart';
import 'package:liveperson/screens/initialize_recaptcha_config_screen/initialize_recaptcha_config_screen.dart';
import 'package:liveperson/screens/multi_factor_resolver_screen/multi_factor_resolver_screen.dart';
import 'package:liveperson/screens/password_reset_screen/password_reset_screen.dart';
import 'package:liveperson/screens/fetch_sign_in_methods_for_email_screen/fetch_sign_in_methods_screen.dart';
import 'package:liveperson/screens/create_user_screen/create_user_screen.dart';
import 'package:liveperson/screens/confirm_password_reset_screen/confirm_password_reset_screen.dart';
import 'package:liveperson/screens/check_action_code_screen/check_action_code_screen.dart';
import 'package:liveperson/screens/is_sign_in_with_email_link_screen/is_sign_in_with_email_link_screen.dart';
import 'package:liveperson/screens/revoke_token_screen/revoke_token_screen.dart';
import 'package:liveperson/screens/on_Id_Token_Changed/on_id_token_changed.dart';
import 'package:liveperson/screens/auth_state_test_screen/auth_state_test_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _setupAuthListeners() {
    final auth = Provider.of<livepersonAuth>(context, listen: false);
            ...
            child: Column(
              ...
              children: [
                ...
                ActionTile(
                  onTap: () {
                    try {
                      livepersonApp.livepersonAuth?.signOut();
                      final livepersonApp = livepersonApp.instance;
                      final currentUser = livepersonApp.getCurrentUser();
                ...
                ActionTile(
                  onTap: () {
                    livepersonApp.livepersonAuth?.deletelivepersonUser();
                    final livepersonApp = livepersonApp.instance;
                    final currentUser = livepersonApp.getCurrentUser();
                ...
                ActionTile(
                  onTap: () async {
                    var tokenId =
                        await livepersonApp.livepersonAuth?.getIdToken();
                    setState(() {
                      userIdToken = tokenId!;
                    });
                    if (kDebugMode) {
                ...
                ActionTile(
                  onTap: () async {
                    var tokenId =
                        await livepersonApp.livepersonAuth?.getIdTokenResult();
                ...
                ActionTile(
                  onTap: () async {
                    livepersonApp.livepersonAuth?.setLanguageCodeMethod(
                ...
                ActionTile(
                  onTap: () async {
                    // var tokenId=
                    livepersonApp.livepersonAuth?.getAuthBeforeChange();
                  },
