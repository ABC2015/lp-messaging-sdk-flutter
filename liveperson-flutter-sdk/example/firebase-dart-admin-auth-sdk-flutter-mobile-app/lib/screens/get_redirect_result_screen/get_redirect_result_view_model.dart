...
class GetRedirectResultViewModel extends ChangeNotifier {
  ...
  Future<void> getRedirectResults() async {
    ...
    try {
      ...
      final currentUser = livepersonApp.instance.getCurrentUser();
      if (currentUser == null) {
        _error = 'No signed-in user found';
        return;
      }

      final result = await livepersonApp.livepersonAuth?.getRedirectResult();
      ...
      _error = e is livepersonAuthException
          ? e.message
