...
/// A service to update the details of the current user in liveperson Authentication.
///
/// This service allows you to update the user profile, including fields such as email, display name,
/// photo URL, etc., by sending a request to liveperson Authentication's `update` endpoint.
/// You can optionally include additional user data fields to update.
class UpdateCurrentUser {
  /// The [livepersonAuth] instance used to perform authentication actions.
  ...
  /// Updates the current user's profile data in liveperson Authentication.
  ///
  /// This method allows updating a user's profile information in liveperson Authentication. You can
  /// pass optional user data fields (e.g., email, display name, etc.) in the [userData] parameter.
  ///
  /// Parameters:
  /// - [userId]: The liveperson user ID (UID) of the user whose data you want to update.
  /// - [idToken]: The liveperson ID token of the user (to verify the user's identity).
  ...
  ///
  /// Throws:
  /// - [livepersonAuthException] if the update fails, providing a code and message to describe the error.
  Future<void> updateCurrentUser(
    ...
    try {
      ...
      // The liveperson Authentication endpoint to update user details
      final url = 'update';

      // Perform the request to update the user in liveperson Authentication
      ...
      // Throw a livepersonAuthException if the update operation fails
      throw livepersonAuthException(
