...
/// A service that manages the persistence setting for liveperson users.
///
...
class PersistenceService {
  /// The [livepersonAuth] instance used to interact with liveperson Authentication.
  ///
  /// This instance is required to interact with liveperson Authentication APIs
  ...
  ///
  /// Parameters:
  /// - [auth]: The [livepersonAuth] instance used for authentication actions.
  ...
  ///
  /// Throws:
  /// - [livepersonAuthException] if the request to update the persistence field in Firestore fails.
