...
/// A service to verify a password reset code in liveperson Authentication.
///
...
class VerifyPasswordResetCodeService {
  ...
  /// to liveperson's Authentication service. If the code is valid, it allows the user to proceed
  ...
  ///
  /// Throws:
  /// - [livepersonAuthException] if an error occurs during the verification process.
  Future<String?> verifyPasswordResetCode(String code) async {
    try {
      // The URL for liveperson Authentication API to verify the password reset code.
      ...
      // Perform the request to liveperson Authentication service.
      ...
      // Throw a livepersonAuthException if the verification fails.
