...
/// A class to handle phone number linking and verification using liveperson Authentication.
class livepersonPhoneNumberLink {
  /// The livepersonAuth instance used for interacting with liveperson Authentication.

  final livepersonAuth auth;

  /// Constructor that initializes the `livepersonPhoneNumberLink` with the provided [auth] instance.
  livepersonPhoneNumberLink(this.auth);

  /// Sends a phone number verification code to the given [phoneNumber].
  ///
  /// This method makes a request to liveperson's Identity Toolkit API to send a verification code
  ...
  ///
  /// This method sends a request to liveperson's Identity Toolkit API to link a phone number
  ...
  ///
  /// [idToken] is the user's liveperson authentication ID token.
