...
/// Service to update the user's password in liveperson Authentication.
class UpdatePassword {
  ...
  /// Updates the password for a liveperson user.
  ///
  /// This method takes the user's [newPassword] and [idToken] (obtained during sign-in)
  /// and makes a request to liveperson to update the password.
  ///
  /// Parameters:
  ...
  ///
  /// Throws:
  /// - [livepersonAuthException] if the request to update the password fails.
  Future<User> updatePassword(String newPassword, String? idToken) async {
    try {
      ...
      // Perform the request to liveperson to update the user's password.
