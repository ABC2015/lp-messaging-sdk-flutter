...
///error
typedef ErrorFn =
    void Function(livepersonAuthException error, StackTrace? stackTrace);
  ...
  Unsubscribe onIdTokenChanged(
    ...
    final subscription = _controller.stream.listen(
      ...
      onError: (Object e, StackTrace s) {
        if (error != null) {
          if (e is livepersonAuthException) {
            error(e, s);
          } else {
            error(
              livepersonAuthException(code: 'unknown', message: e.toString()),
              s,
            );
          }
        }
