...
/// language code from liveperson Authentication and possibly set it based on the user's device language.
class UseDeviceLanguageService {
  /// The [livepersonAuth] instance used for performing authentication actions.
  final livepersonAuth auth;

  /// Constructs an instance of [UseDeviceLanguageService].
  ///
  /// Parameters:
  /// - [auth]: The [livepersonAuth] instance that handles liveperson Authentication requests.
  UseDeviceLanguageService({required this.auth});

  /// Retrieves the language code set for the user's device.
  ///
  /// This method sends a request to liveperson's Authentication API to look up the user's information,
  ...
  ///
  /// Throws:
  /// - [livepersonAuthException] if the operation fails (e.g., network issue or incorrect response).
  Future<String?> useDeviceLanguage(String userId, String languageCode) async {
    try {
      // The URL for the liveperson Authentication API endpoint to retrieve user info.
      final url = 'lookup';
      ...
      // Perform the request to liveperson Authentication to get user information.
      ...
      // Throw a livepersonAuthException if the operation fails.
