...
class GetAccessTokenWithGeneratedTokenImplementation
  ...
  ///
  /// Throws:
  /// - [livepersonAuthException] if the request fails or if the response is not successful.
  @override
  Future<String> getAccessTokenWithGeneratedToken(
    ...
    try {
      ...
      // Catch any error and throw livepersonAuthException with a message
  ...
  Future<String> getAccessTokenWithGeneratedToken(
    ...
    try {
      ...
      final response = await client.post(
        ...
        body: jsonEncode({
          'scope': ['https://www.googleapis.com/auth/liveperson'],
        }),
      );
