...
/// Service to monitor and manage liveperson authentication state changes.
///
/// This service listens to the liveperson authentication state and
...
class OnAuthStateChangedService {
  /// The [livepersonAuth] instance used to listen for authentication state changes.
  ...
  ///
  /// Parameters:
  /// - [auth]: The [livepersonAuth] instance that triggers the auth state events.
  ///
  ...
  OnAuthStateChangedService(this._auth) {
    // Listen to the simplified stream from livepersonAuth
